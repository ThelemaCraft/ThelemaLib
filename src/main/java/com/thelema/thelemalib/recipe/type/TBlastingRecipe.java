...
public class TBlastingRecipe extends TAbstractCookingRecipe {
    public TBlastingRecipe(String group, CookingBookCategory category,
                           Ingredient ingredient, ItemStack template, float experience, int cookingTime,
                           JsonArray handle) {
        super(RecipeType.BLASTING, group, category, ingredient, template, experience, cookingTime, handle);
    }
